...
if [ "$(uname -m | grep 'x86_64' | wc -l)" -gt 0 ]; then
    ...
    docker build --no-cache -t registry.gitlab.com/alexhaydock/alexhaydock.co.uk:aarch64 .
    docker push registry.gitlab.com/alexhaydock/alexhaydock.co.uk:aarch64
else
